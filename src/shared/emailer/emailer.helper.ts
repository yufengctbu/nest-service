 ...
 * @returns
 */
export const createRegisterCodeHtml = (code: string, email: string): [string, string] => {
    const title = `${pkg.name} 账户注册`;
 ...
 * @returns
 */
export const createModifyPasswordCodeHtml = (code: string, email: string): [string, string] => {
    const title = `${pkg.name} 账户修改密码`;
